...
class Mysqli2 extends mysqli
{
    ...
    public static $logfile_folder_path = 'D:/htdocs/fimo/logs';
                ...
                if ($result->num_rows) {
                    while ($row = $result->fetch_row()) {
                        ...
                        if ($result_filter[1] === null) {
                            ...
                            } elseif (substr($result_filter[1], 0, 8) === 'string=>') {
    ...
    public function query1($query, $return = null)
    {
        ...
        if ($return === 0) {
            ...
            return $row[0];
        } elseif (is_numeric($return) and ($return > 0)) {
            $row = $result->fetch_row();
